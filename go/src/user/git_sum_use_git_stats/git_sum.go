...
func main() {
	...
	filepath.Walk("/Volumes/Transcend/Company/MrWind", walkFunc)
...
func gitLogCommand(path string, dest string) string {
	...
	return "git_stats generate -p " + path + " -o " + dest + " -l zh_cn"
}
